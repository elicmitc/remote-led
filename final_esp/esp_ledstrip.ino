...
#define LED_PIN     4
//#define LED_PIN_S   5
#define LED_COUNT  600//600 // 150 * 5
//#define LED_COUNT_S 150
#define BRIGHTNESS 150 // 0-255
Adafruit_NeoPixel strip(LED_COUNT, LED_PIN, NEO_GRB + NEO_KHZ800);
//eAdafruit_NeoPixel strip_s(LED_COUNT_S, LED_PIN_S, NEO_GRB + NEO_KHZ800);
String response;
int r=20, g=20, b=20;
int clicks = 0;
// end of led info 
void setup() {
  ...
  // put your setup code here, to run onc0:
  Serial.begin(115200);
  ...
  //strip_s.begin(); // mandatory   strip.clear(); // clear all leds
  strip.setBrightness(BRIGHTNESS);
  //strip_s.clear(); // clear all leds
...
int change_strip(int red, int green, int blue){
  ...
  delay(10);
  /*for(int j=0; j<LED_COUNT_S; j++){
    if(digitalRead(BUTTON_PIN) == LOW){
      Serial.println("button pressed");
      return 0;
    }
    strip_s.setPixelColor(j, strip_s.Color(red, green, blue));
    strip_s.show();
    delay(5);
  }*/
  return 1;
